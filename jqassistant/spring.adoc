[[spring:Default]]
[role=group,includesGroups="spring-boot:Strict",includesConstraints="spring:ControllerMustBeLocatedInWebLayer,spring:ServiceMustBeLocatedInServiceLayer,spring:RepositoryMustBeLocatedInRepositoryLayer,spring:ImplementationDependencies,dependency:PackageCycles",includesConcepts="spring:VirtualDependency.graphml"]
== Spring Components
