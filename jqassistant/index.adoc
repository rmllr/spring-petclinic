...
[[default]]
[role=group,includesGroups="maven:Default,layer:Default,spring-component:Default,model:Default,business:Default,management:Default,test:Default,vcs:Default"]
- <<maven:Default>>
- <<layer:Default>>
